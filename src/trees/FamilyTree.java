...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("not good index");// throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("null parent");
			}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("not good name");
		}
